...
public class Ex4 extends JFrame {
    ...
    private JTable tableStudent, tableClass;
    private DefaultTableModel modelStudent, modelClass;
    ...
    public Ex4() {
        setTitle("Ex4: Student and Class Management with Search");
        setSize(850, 650);
        ...
        add(tabbedPane);
        loadDataStudent("SELECT * FROM SinhVien", null);
        loadDataClassroom();
    }
